...
namespace PayrollSystemTest
{
    public class HourlyEmployee : Employee
    {
        ...
        public HourlyEmployee(string firstName, string lastName, string socialSecurityNumber, Date birthDate, decimal hourlyWage, decimal hoursWorked)
        ...
        // property that gets and set hourly employee's wage
        public decimal Wage
        {
            get
            {
