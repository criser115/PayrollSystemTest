...
/// CommissionEmployyee Class that extends Employee.
/// </summary>
...
namespace PayrollSystemTest
{
    public class CommissionEmployee : Employee
    {
        ...
        public CommissionEmployee(string firstName, string lastName, string socialSecurityNumber, Date birthDate, decimal grossSales, decimal commissionRate)
